...
namespace CasaDoCodigo.Repositories
{
    public interface IPedidoRepository
    {
        ...
        UpdateQuantidadeResponse RemoveItemPedido(ItemPedido itemPedido);
    ...
    public class PedidoRepository : BaseRepository<Pedido>, IPedidoRepository
    {
        ...
        //Atualiza a quantidade de um dos itens do pedido
        ...
        public UpdateQuantidadeResponse RemoveItemPedido(ItemPedido itemPedido)
        {
            ItemPedido itemPedidoDB = itemPedidoRepository.GetItemPedido(itemPedido.Id);
            contexto.Set<ItemPedido>().Remove(itemPedidoDB);
